...
- [node-red-contrib-mssql-plus](https://github.com/bestlong/node-red-contrib-mssql-plus) - A Node-RED node to execute queries, stored procedures and bulk inserts in Microsoft SQL Server and Azure Databases SQL2000 ~ SQL2019.
...
- [node-red-contrib-xiaomi-ble](https://github.com/eschava/node-red-contrib-xiaomi-ble) - This Node-Red module contains single "Xiaomi BLE" node that gets all known data from Xiaomi BLE (Bluetooth 4) devices using Bluetooth 4 compatible adapter.
...
- [node-red-contrib-discord-advanced](https://github.com/Markoudstaal/node-red-contrib-discord-advanced) - Node-red nodes that allow you to interact with Discord, via Discord.js.
...
- [node-red-contrib-blindcontroller](https://github.com/alisdairjsmyth/node-red-contrib-blindcontroller) - A collection of Node-RED nodes that automate the control of household roller blinds based on the current position of the sun.
...
- [node-red-contrib-state-machine](https://github.com/DeanCording/node-red-contrib-state-machine) - A Node Red node that wraps around the JavaScript State Machine to implement a finite state machine for Node Red.
...
- [node-red-contrib-avr-yamaha](https://github.com/krauskopf/node-red-contrib-avr-yamaha) - This package contains nodes to easily integrate and control YAMAHA™ audio/video receiver from Node-RED via YNCA protocol (e.g. AVRs like the model Yamaha RX-677).
...
- [node-red-contrib-harmony](https://github.com/Aietes/node-red-contrib-harmony) - Control your devices connected to a Logitech™ Harmony Hub from Node-RED.
...
- [node-red-contrib-tahoma](https://github.com/nikkow/node-red-contrib-tahoma) - Node-RED module to control a Somfy Tahoma box (Roller shutters, etc.). 
- [node-red-contrib-tasmota](https://github.com/DaveMDS/node-red-contrib-tasmota) - Tasmota devices integration for building automation inside Node-RED.
